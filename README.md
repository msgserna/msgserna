...
- 🎨 Build modern, consistent UIs with **React, Next.js, Tailwind CSS** and **shadcn/ui**
- 🗄️ Design and optimize **relational databases** (PostgreSQL, MySQL) and work with NoSQL (MongoDB)
- 🔗 Develop and integrate **REST APIs** with Node.js
- 📦 Take projects from concept to production: planning, UI/UX, data integration, and backend services
- ✅ Focus on maintainable code, proper architecture, and solutions that work in real environments
...
- 📊 **Big Data & AI/ML** — exploring data processing and intelligent systems
- ☁️ **DevOps & Cloud Infrastructure** — automation, CI/CD, and scalable deployments
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/msserna/)

---

*"Code should be clean, maintainable, and built for real users."*
